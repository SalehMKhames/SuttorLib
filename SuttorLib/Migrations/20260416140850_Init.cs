        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Descritpion = table.Column<string>(type: "varchar(300)", maxLength: 300, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "4767a1b4-71b2-44c2-9191-98fc4a28b79d", "66d9f325-525e-4ef9-b1ef-b0260a8fbaae", "Author", "AUTHOR" },
                    { "9ca535e7-d5ad-4dc2-b2ac-2583fd6018cc", "23c4fa54-678d-4637-8d7e-c507d49e759f", "Admin", "ADMIN" },
                    { "a0a3c4c2-1e2f-421d-aabe-8055d1f8d94a", "b4f5f44e-0e0c-48bf-a3a4-3da64c9fa03b", "User", "USER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "09ecb732-1b03-4e8b-9d33-f94abd78e10c", 0, "5830a4ab-95c9-4fc4-881c-fa3f4272a7f1", "authorDemo@example.com", true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Author User", true, true, new DateTime(2026, 4, 16, 14, 8, 48, 997, DateTimeKind.Utc).AddTicks(8064), false, null, "AuthorDEMO@EXAMPLE.COM", "Author", "AQAAAAIAAYagAAAAEA2oHKAJB9OOOnB8db8dZN4owPhXi07nYg1ka7pIn5B2/k7eymW9LLf40iEB5qz5zA==", null, false, "", "0afac937-358f-4005-8af8-fc5976c5202b", "", false, "AuthorUser", 1000 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "552e570e-c5d9-4cfb-8cec-f027b8f14ef0", 0, "2e61ac59-4237-4f42-a0fb-406bca718299", "userDemo@example.com", true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Demo User", true, new DateTime(2026, 4, 16, 14, 8, 48, 997, DateTimeKind.Utc).AddTicks(8047), false, null, "USERDEMO@EXAMPLE.COM", "USER", "AQAAAAIAAYagAAAAEEF+5t88R5Neb/6vNLNnkHJVA1Bw8fSxyhb5ehuSjvh09tL16th1OqqILsmVky+Qdw==", null, false, "", "b7e7a44d-de00-4414-8b3e-06c6e8cef6a3", "", false, "User", 0 },
                    { "dbc170db-1651-4dc4-96b0-be5042244590", 0, "6ad2cde8-6c73-4dad-b650-fbf3269c0bc7", "salehalk512@gmail.com", true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Saleh", true, new DateTime(2026, 4, 16, 14, 8, 48, 997, DateTimeKind.Utc).AddTicks(4766), false, null, "SALEHALK512@GMAIL.COM", "ADMINSALEH", "AQAAAAIAAYagAAAAEHZ6uUnFEPmCND6xUv9ILADFEmyqdGv2hDLJ8UPjQQ16wFiyf/Fxop+gV9rzLljNvg==", null, false, "", "8bcd66e1-5b1d-45dc-b3c4-24c8cb2e4ac5", "", false, "AdminSaleh", 100000 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("059c2f59-88fe-4af3-982f-2ae959eb8142"), "Music Theory & History" },
                    { new Guid("09cdc617-ef94-415e-b765-8e8c4333a87e"), "Religious Studies & Theology" },
                    { new Guid("0aca8524-9e93-4c77-b93d-e95ae70bcc6d"), "Gardening & Nature" },
                    { new Guid("1636fc87-7acc-4885-84f6-e264568983d6"), "Materials Science" },
                    { new Guid("185a0745-3239-4b51-80fd-53046f64a021"), "Sociology" },
                    { new Guid("18bab85f-b830-4f33-a99e-28338fdf63e1"), "Economics" },
                    { new Guid("20ee7663-270d-4ddc-9a67-6622887991a1"), "Memoir & Autobiography" },
                    { new Guid("276d5636-3f8c-46bc-89b2-53940d93d1ab"), "Cooking & Culinary Arts" },
                    { new Guid("27bb938d-17b4-4bf7-987e-8f0cd974b155"), "Art History & Criticism" },
                    { new Guid("28e2a50e-15ad-4c90-bf3a-e096add0b459"), "Philosophy" },
                    { new Guid("2ab87d0f-c8a7-4157-bd71-38792c673961"), "Romance" },
                    { new Guid("30aa0e05-893a-4578-914f-92bba0bd27ca"), "Poetry" },
                    { new Guid("32575e89-4921-425c-8d86-cf3513f22c0c"), "Geology" },
                    { new Guid("3b09cfbe-2228-4cb6-b53e-3eb37c474adc"), "Travel & Adventure" },
                    { new Guid("3fc19bbc-afd5-4807-8736-ce582c8ef17a"), "Medicine & Public Health" },
                    { new Guid("40623ec7-2785-4a29-b70b-f09d5b25cbc2"), "Magical Realism" },
                    { new Guid("445c9a6d-9c01-45ad-a16e-dc8c54543682"), "Fantasy" },
                    { new Guid("53ab2bd5-81f3-4310-a1dc-6b77f22f50c9"), "True Crime" },
                    { new Guid("56b74a04-e3cb-4f1d-adf0-9295b690169a"), "Science Fiction" },
                    { new Guid("59811744-a516-4667-8fa6-0fac8dde137c"), "Architecture & Design" },
                    { new Guid("60b2e3e6-d86e-47e4-9df8-01fee7d3fd5d"), "Ecology" },
                    { new Guid("616d080e-0d77-4ea0-8eaa-30d325648ebc"), "Films & Television Studies" },
                    { new Guid("618daacc-fbcb-4f77-b288-56caf7226609"), "Physics" },
                    { new Guid("6273f2df-dfd4-4d06-8457-cecec93a3562"), "Astronomy & Cosmology" },
                    { new Guid("6b1839b1-6c56-4d79-afae-5df866232849"), "Technology Guides & Tutorials" },
                    { new Guid("6debc6f5-f384-481e-afe3-9e6b173c6f82"), "Horror" },
                    { new Guid("75290b21-ce0d-48e3-99d9-d75ed3a4fde9"), "Mathematics" },
                    { new Guid("7da6870d-9cb2-4aa5-95a3-4e62418308e9"), "Chemistry" },
                    { new Guid("95b44795-7dc6-4178-ac95-99086bce7ab2"), "Photography" },
                    { new Guid("9f7742ba-2b0b-4e04-b435-3b578d109aa7"), "Business & Enteroreneurship" },
                    { new Guid("a7e919bb-bf79-4eac-9dce-2154a5571265"), "Fashion & Style" },
                    { new Guid("a93e245c-1bd3-472e-b695-36eea7697287"), "Self-Improvement & Productivity" },
                    { new Guid("abe89581-6436-4e00-a3b2-223f3f195ec1"), "Folklore & Mythology" },
                    { new Guid("abfeeac3-0157-41e0-89ed-434ad19c613a"), "Sports & Athletics" },
                    { new Guid("b7db4644-1821-4791-863e-9036b9832bc9"), "Biology" },
                    { new Guid("bc83d50d-4b4c-4e4e-9796-ae122694a207"), "History" },
                    { new Guid("bc942777-d98f-46a4-b791-bd15d5379686"), "Political Science & Theory" },
                    { new Guid("bcb17902-a2ba-4303-8442-64ff1d25e7fa"), "Neuroscience & Psychology" },
                    { new Guid("c51ac3f9-9b3e-4bde-b5a2-719c7f136e5a"), "Linguistics" },
                    { new Guid("d347d353-be64-4dfb-a971-29834a319564"), "Comics & Graphic Novels" },
                    { new Guid("d3e4da92-451d-436e-bab9-8e6cbf4a690e"), "Mystery" },
                    { new Guid("d5041526-f649-474b-8fda-9c625c490549"), "Kids Stories" },
                    { new Guid("d955be30-3a52-423e-bd07-b4e0313532d7"), "Computer Sceince & A.I." },
                    { new Guid("dc01d58a-7356-49fd-bfea-1a0878b2f6ca"), "Essays & Scientific Papers" },
                    { new Guid("ddc11cd6-4eb0-437c-93cc-0d0d68ab2f50"), "Historical Fiction" },
                    { new Guid("e991eec3-fd73-4647-af30-dd948c7d9627"), "Personal Finance & Investing" },
                    { new Guid("f2a97e36-3d1d-4568-b0cd-376f75ce7576"), "Anthropology & Archaelogy" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0451c99e-9748-4315-8fde-a6132c9918c5"), "Polish", "pl" },
                    { new Guid("092d0549-2692-443b-80a8-f9d0b7a33b00"), "Lithuanian", "lt" },
                    { new Guid("0a4a28b2-65a5-4e4d-865b-c15a6afdd280"), "English", "en" },
                    { new Guid("0c6b3793-2438-4fba-b866-c893fca2826d"), "Filipino", "fil" },
                    { new Guid("0d3ab24c-8aa5-469f-ac4a-4db13ed632ab"), "Hungarian", "hu" },
                    { new Guid("123efb9e-1147-4a1c-8c90-7941840d2c92"), "Hindi", "hi" },
                    { new Guid("17b7ad7e-90dd-42e4-9158-6f30c34bcad7"), "Serbian", "sr" },
                    { new Guid("19a3d448-a188-45ec-a4f2-8f388fe6e407"), "Irish", "ga" },
                    { new Guid("224a7bf8-3f81-44ce-8f1b-0c2b98c72ab1"), "Persian", "fa" },
                    { new Guid("2a049d7e-a3e6-4ee8-bfbb-90944b2edf15"), "Slovak", "sk" },
                    { new Guid("2d28d30c-aa55-47fe-a31f-b818885c0e63"), "Japanese", "ja" },
                    { new Guid("2f3d7ef0-4cc5-41ca-bc5a-f6f0a3b52d1e"), "Vietnamese", "vi" },
                    { new Guid("333bf339-02bb-4391-a14b-6d2787fefb50"), "Telugu", "te" },
                    { new Guid("337292c0-21a6-4442-ad25-bf3972484617"), "Ukrainian", "uk" },
                    { new Guid("3f32c9d6-087f-466b-a675-64367c9e4cad"), "Czech", "cs" },
                    { new Guid("4113f2eb-3c28-4d59-a5f8-13a276c85efd"), "Indonesian", "id" },
                    { new Guid("43422893-90e6-41a7-a03c-1f535f55e168"), "Arabic", "ar" },
                    { new Guid("48a0b47f-0fc7-4e33-890d-8364b2065d88"), "Bulgarian", "bg" },
                    { new Guid("4d141410-37ce-4819-9874-009713f41582"), "Urdu", "ur" },
                    { new Guid("52bbf334-8c3a-470a-af7a-389889fabd31"), "Afrikaans", "af" },
                    { new Guid("55d988c7-e4ce-48f2-8ba0-4307b2182883"), "Hebrew", "he" },
                    { new Guid("5bfc7493-a196-48b4-92bd-fbffdadfa148"), "Spanish", "es" },
                    { new Guid("5d192506-f26b-4771-9aa6-c1e9772d768a"), "Danish", "da" },
                    { new Guid("5f1a8418-85a1-4431-91e8-f034c9de930e"), "Korean", "ko" },
                    { new Guid("6027059e-0d9f-4067-819b-1fa8144455c4"), "Kannada", "kn" },
                    { new Guid("65ae1136-a792-4d4e-b958-c35f3bf8c94a"), "Swedish", "sv" },
                    { new Guid("6629266b-a8a5-45e9-a281-c971096a648e"), "Bengali", "bn" },
                    { new Guid("6ab37ca6-f34d-49f5-88f7-00f4a5686cd2"), "Russian", "ru" },
                    { new Guid("6c2f4bce-371d-4256-b8bd-f2d455882200"), "Malay", "ms" },
                    { new Guid("713ead7f-1c98-4cd7-8a85-693b5f9651ed"), "Latvian", "lv" },
                    { new Guid("72dbf3c7-a0b1-48ef-bf02-b0ea0482cb51"), "Finnish", "fi" },
                    { new Guid("7b24e889-238e-4b6e-9504-8fa388af891f"), "Norwegian", "no" },
                    { new Guid("7f3bf3ac-9a1d-491b-bc69-8d73a606429f"), "German", "de" },
                    { new Guid("80be09af-3228-4bb2-83e1-ed7dbb4e9e7b"), "Croatian", "hr" },
                    { new Guid("83ffab19-15f6-45a1-8bb8-a01470f990bc"), "Tamil", "ta" },
                    { new Guid("8a27999c-c0fb-4223-8d69-1794f5a5ff1a"), "Gujarati", "gu" },
                    { new Guid("a6566dfc-1376-4dca-8228-91a7ed44e821"), "Swahili", "sw" },
                    { new Guid("ace60b46-08cb-46ad-8598-00cc33ed1b7b"), "Greek", "el" },
                    { new Guid("b377118b-a6b1-45fa-9ab0-c4295092baba"), "Thai", "th" },
                    { new Guid("b90990ed-8f33-4d84-8070-a2e25727b902"), "Slovenian", "sl" },
                    { new Guid("bca83a36-4a03-4290-8233-2ad2479da2bf"), "Marathi", "mr" },
                    { new Guid("be56d48d-dfa0-44c5-994f-33fa9e911fa4"), "Estonian", "et" },
                    { new Guid("bf3b64d2-04cd-400e-9fd3-676b9f378837"), "Punjabi", "pa" },
                    { new Guid("c3556e0f-f385-44d9-b187-a72895e4ab20"), "Romanian", "ro" },
                    { new Guid("c9d8a96e-ab6a-4ea0-99de-ecd3d74965b3"), "Tagalog", "tl" },
                    { new Guid("d1fd2bf1-e90d-4e57-80e6-60209352a90a"), "Italian", "it" },
                    { new Guid("db7d6aa2-c969-4c3f-87a8-0f5c74558bee"), "Malayalam", "ml" },
                    { new Guid("dc26dd36-f8fd-4749-836c-e3801e7d8017"), "Dutch", "nl" },
                    { new Guid("e56e0113-60e5-4f12-968d-14f80a2f7765"), "Portuguese", "pt" },
                    { new Guid("e9f86663-5340-4a10-b009-60a4202800ee"), "Turkish", "tr" },
                    { new Guid("ee410d5a-0de4-4aa8-b744-1c838090a85d"), "Icelandic", "is" },
                    { new Guid("f18d9a90-383a-4d3b-a8ca-dcc8aaace604"), "Mandarin Chinese", "zh" },
                    { new Guid("f74c4ab4-1d68-43f4-b846-d61d85a95875"), "French", "fr" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "4767a1b4-71b2-44c2-9191-98fc4a28b79d", "09ecb732-1b03-4e8b-9d33-f94abd78e10c" },
                    { "a0a3c4c2-1e2f-421d-aabe-8055d1f8d94a", "552e570e-c5d9-4cfb-8cec-f027b8f14ef0" },
                    { "9ca535e7-d5ad-4dc2-b2ac-2583fd6018cc", "dbc170db-1651-4dc4-96b0-be5042244590" }
                });
