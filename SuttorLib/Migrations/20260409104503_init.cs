    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "50a7790a-3fd5-478b-a172-b4e7c2964458", "1834b536-60c0-404d-9042-444b8b8865cc", "Admin", "ADMIN" },
                    { "acdda282-a46f-4df9-b77d-33afd812389b", "b6ac8c3e-bc3e-4933-a6d1-a2aa2af1330f", "User", "USER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "7dde9aca-0c74-4f61-8f50-de34dd298885", 0, "323b2c12-204b-4a76-8afc-45634fa9e0df", "userDemo@example.com", true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Demo User", true, false, new DateTime(2026, 4, 9, 10, 45, 2, 560, DateTimeKind.Utc).AddTicks(1841), false, null, "USERDEMO@EXAMPLE.COM", "USER", "AQAAAAIAAYagAAAAECYXAUQXaB9JFsFDMv7uWdiolXpy7KAQYH2uutnxBmlzyTU9NRV1MlKYl22iTUFWLQ==", null, false, "", "c44a29ed-3e79-42fd-af3c-80d1ddc7874f", "", false, "User", 0 },
                    { "82334985-08b0-460e-9d02-abe3240ce0a8", 0, "37a5d44d-d9c1-471e-bb2f-0f99bc351352", "salehalk512@gmail.com", true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "System Administrator Saleh", true, false, new DateTime(2026, 4, 9, 10, 45, 2, 560, DateTimeKind.Utc).AddTicks(429), false, null, "SALEHALK512@GMAIL.COM", "ADMINSALEH", "AQAAAAIAAYagAAAAEOZW8xLwsnCyk2n9ldzV34roPe6gcs+To7uQx54d0gUQdCQbe/YKcCver3PZESGzog==", null, false, "", "8ad637fd-7de3-48d7-84ec-f2da74f34c29", "", false, "AdminSaleh", 100000 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1a7e1426-50f2-49fc-b075-1ea37f73d2e9"), "Philosophy" },
                    { new Guid("1db30ae3-d371-40ff-bbd2-a5ca5679f30f"), "Ecology" },
                    { new Guid("2217ac1b-b2a1-4290-8e1c-79bcdd578c59"), "Religious Studies & Theology" },
                    { new Guid("239fed4f-5ac1-4ffe-83a6-ad34d4d03654"), "Medicine & Public Health" },
                    { new Guid("2b24b8d6-db5f-43e1-aedb-858e8f723b7b"), "Comics & Graphic Novels" },
                    { new Guid("2b40cb7d-3bf7-4366-81fc-ce17b248f710"), "Mathematics" },
                    { new Guid("2cd1a582-4816-4506-90cb-4b4a05e3fb24"), "Romance" },
                    { new Guid("3117239d-49d6-45ca-b962-2ca366f34c64"), "Political Science & Theory" },
                    { new Guid("31a44700-79e2-4a49-a490-07d85fae36f0"), "Historical Fiction" },
                    { new Guid("37b7a43d-e70e-486f-bc0f-6c17b7dfce8f"), "Memoir & Autobiography" },
                    { new Guid("39014a77-c69f-42a9-a404-3ee9ffd92add"), "History" },
                    { new Guid("3a97df04-41ea-4874-bdec-fcfd1c743375"), "Photography" },
                    { new Guid("3b60157a-7790-4f7b-a8ce-8c8c94584576"), "Anthropology & Archaelogy" },
                    { new Guid("4832828f-2aef-47d8-8fac-761bc93e945a"), "Art History & Criticism" },
                    { new Guid("55990fa2-2727-4585-8204-4c654915dc65"), "Poetry" },
                    { new Guid("6d79b5f5-c0dc-40fd-9829-037b34989d35"), "Fashion & Style" },
                    { new Guid("6dc21614-e951-4b5c-a709-22c52bf77ce8"), "Cooking & Culinary Arts" },
                    { new Guid("70a80780-05a1-4ad4-aaba-edd39de6f322"), "Architecture & Design" },
                    { new Guid("79ae2416-76f5-45c5-9894-05d46c081ab8"), "Films & Television Studies" },
                    { new Guid("7b73f24e-be32-487a-a77b-f2726d9fe597"), "Neuroscience & Psychology" },
                    { new Guid("7be1b448-c7a0-4cac-83ee-ba180da69a43"), "Sociology" },
                    { new Guid("88149328-7c96-4fe1-85f5-17839d67af8a"), "Business & Enteroreneurship" },
                    { new Guid("8f47bcaa-5651-445c-8fb2-4f649536b87c"), "Essays & Scientific Papers" },
                    { new Guid("8fb8d059-c7b3-40d8-a3ed-4340dc815dcd"), "Self-Improvement & Productivity" },
                    { new Guid("9494b8dd-81cb-4a0a-8069-b0c15b164d60"), "Magical Realism" },
                    { new Guid("959bf792-36f4-463a-86be-1724c9181113"), "Travel & Adventure" },
                    { new Guid("96f7287f-5a2d-4713-a1cd-57ff025ebcdc"), "Sports & Athletics" },
                    { new Guid("a0ade0ca-88c9-45dc-80b6-f678d96208f8"), "Gardening & Nature" },
                    { new Guid("a743b565-3147-4334-b5e5-2a716ab47491"), "Astronomy & Cosmology" },
                    { new Guid("ab3a72e9-e1f9-4185-96ea-2495c123da7c"), "Materials Science" },
                    { new Guid("b1685894-a333-4649-9327-d60caf833ebd"), "Linguistics" },
                    { new Guid("bad67f5e-853e-47ca-a283-59e74d1422f7"), "Physics" },
                    { new Guid("c08117da-b56d-46fb-81f1-d2c35822aa04"), "Geology" },
                    { new Guid("c5999278-5443-436c-921c-fea46b2f7da2"), "Fantasy" },
                    { new Guid("cca579d5-79f6-4670-9ebe-be2be2a1d020"), "Biology" },
                    { new Guid("cfb67bc2-1887-40e5-8814-df84e0260dbf"), "Horror" },
                    { new Guid("d0792787-eeb8-4306-9442-fed275cbe4b5"), "Computer Sceince & A.I." },
                    { new Guid("d0b8d077-657c-4d1d-8802-20d3f044a236"), "Kids Stories" },
                    { new Guid("d9de99ce-7631-4426-a1e5-923eb9b69194"), "Music Theory & History" },
                    { new Guid("d9fd4f82-514d-41d0-9a27-728b25de141d"), "True Crime" },
                    { new Guid("db2a699f-7bc8-40a6-afbf-3a3edb503955"), "Mystery" },
                    { new Guid("de0f7dd5-aa2f-43f9-a67c-e75cb16c1a92"), "Economics" },
                    { new Guid("dfa5f1db-2ed2-4dab-a0e6-a76b8067fe51"), "Chemistry" },
                    { new Guid("dfc22086-5afe-4542-bb12-c0931a3638b4"), "Science Fiction" },
                    { new Guid("e3b932ad-fe52-4618-8f4b-e3e08327e05a"), "Folklore & Mythology" },
                    { new Guid("e90eaa7b-06ef-43f4-8717-0ad81f366b28"), "Technology Guides & Tutorials" },
                    { new Guid("ef80eac3-b3bc-4c1b-892e-28441c08b91c"), "Personal Finance & Investing" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("126c68b8-85f9-4dbd-b009-1ab984b72916"), "Spanish", "sp" },
                    { new Guid("51060d75-cd8e-459e-a8e9-b86014e8680c"), "English", "en" },
                    { new Guid("62201fcb-9729-4357-a2ce-30f4cea51d73"), "Portuguese", "pr" },
                    { new Guid("6b5878d9-5fa3-43d6-b38f-8df66f2436c7"), "German", "gr" },
                    { new Guid("6f9d1e78-fda8-406c-9d3a-2e6975eddd51"), "Dutch", "du" },
                    { new Guid("7216b632-5a58-48a2-8dcc-163524d3224d"), "Turkish", "tr" },
                    { new Guid("94f516e8-3b20-457b-88e1-64eebef70362"), "French", "fr" },
                    { new Guid("e38701d7-23d1-483f-bc8f-069ceb9c0d84"), "Chinese", "ch" },
                    { new Guid("f4e44c86-82c1-4837-be33-0c3194e09a6a"), "Arabic", "ar" },
                    { new Guid("fe97bc80-0746-456f-bee1-0b4f4175cdea"), "Russian", "ru" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "acdda282-a46f-4df9-b77d-33afd812389b", "7dde9aca-0c74-4f61-8f50-de34dd298885" },
                    { "50a7790a-3fd5-478b-a172-b4e7c2964458", "82334985-08b0-460e-9d02-abe3240ce0a8" }
                });
